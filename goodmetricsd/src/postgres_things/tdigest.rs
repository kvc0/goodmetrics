...
impl From<&goodmetrics::TDigest> for SqlTdigest {
    fn from(value: &goodmetrics::TDigest) -> Self {
        Self {
            version: 1,
            max_buckets: 100,
            count: value.count,
...
impl From<&goodmetrics::t_digest::Centroid> for SqlCentroid {
    fn from(value: &goodmetrics::t_digest::Centroid) -> Self {
        Self {
            mean: value.mean,
            weight: value.weight,
        }
